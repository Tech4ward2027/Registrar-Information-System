...
test('register throttles after 10 requests per minute from the same IP', function () {
    Mail::fake();
    ...
    $blocked = $this->postJson('/api/undergrad-requestors/register', undergradRegistrationPayload());
